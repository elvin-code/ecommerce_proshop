...
export const getUserDetails = (id) => async (dispatch, getSate) => {
    try{
...
export const updateUserProfile = (user) => async (dispatch, getSate) => {
    try{
...
export const deleteUser = (id) => async (dispatch, getSate) => {
    try{
...
export const updateUser = (user) => async (dispatch, getSate) => {
    try{
